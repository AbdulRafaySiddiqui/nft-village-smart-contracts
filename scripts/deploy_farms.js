...
async function main() {
  ...
  await (await chief.depositRewardToken(0, 0, 0, COMMON_REWARD.mul(27000))).wait();
  console.log("0");
  await sleep(10);
  await (await chief.depositRewardToken(0, 1, 0, RARE_REWARD.mul(27000))).wait();
  console.log("1");
  await sleep(10);
  await (await chief.depositRewardToken(0, 2, 0, SUPER_RARE_REWARD.mul(27000))).wait();
  console.log("2");
  await sleep(10);
  await (await chief.depositRewardToken(0, 3, 0, EPIC_REWARD.mul(27000))).wait();
  console.log("3");
  await sleep(10);
  await (await chief.depositRewardToken(0, 4, 0, LEGENDARY_REWARD.mul(27000))).wait();
  console.log("4");
  await sleep(10);
  await (await chief.depositRewardToken(0, 5, 0, SPECIAL_RARE_REWARD.mul(27000))).wait();
  console.log("5");
  await sleep(10);
  await (await chief.depositRewardToken(0, 6, 0, SPECIAL_SUPER_RARE_REWARD.mul(27000))).wait();
  console.log("6");
  await sleep(10);
  await (await chief.depositRewardToken(0, 7, 0, TOKEN_REWARD.mul(27000))).wait();
  console.log("7");
}
